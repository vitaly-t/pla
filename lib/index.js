...
// TODO:
// 1. Possible: Add promise library recognition, such as name/version;
//    this can be done by loading the library's module from the cache,
//    then accessing its package.json file for the name + version;
// 2. Add inspect support, to output: this library version, plus the adapted library version,
//      plus the adapted library name;
// 3. At the very least, I will need: create, resolve, reject, all
// 4. Consider adding a list of known adapters
